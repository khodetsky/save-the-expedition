        ...
        <>
            <Wrapper>
                ...
                <TextContainer ref={text}>
                    <Text>Настали часи, коли людям стало тісно на рідній планеті та вони вирішили колонізувати інші. Для цього масово почали виготовляти роботів,<br/> які могли спокійно працювати у <br/> непридатних для людини <br/>умовах.</Text>    
                </TextContainer>
