    ...
    return (
        ...
        <Wrapper>
            ...
            <TextContainer ref={text}>
                    <Text>Вершиною людської праці став робот, який очолив першу експедицію на іншу планету. <br/>Її ціллю було зведення людського поселення та облаштування там придатних для людини умов існування.</Text>    
            </TextContainer>
